...
\frameT{Preference Reasoning}{
	...
	\begin{enumerate}
		\item Preference Optimization\footcitefull{lang:aggLP}\textsuperscript{,}\footcitefull{wsh/mpref14/LiuT}\textsuperscript{,}\footcitefull{conf/adt15/liuT}:
			\begin{itemize}
			...
			\end{itemize}
		\item Preference Aggregation\footcitefull{conf/adt13/LiuT}:
			\begin{itemize}
