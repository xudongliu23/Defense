...
%%%%%%%%%%%%%%% Get rid of footline with these lines uncommented
...
\newcommand{\pip}[1]{\mathit{\Pi^P_#1}}
...
\newdateformat{mydate}{\datedayname, \THEMONTH/\THEDAY/\THEYEAR}
...
\institute{Advisor: Dr. Miroslaw Truszczynski \linebreak \linebreak
...
%\section{Student Involvement in Research}
%\input{studentInvolvement}
